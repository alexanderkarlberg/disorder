...
both the NC and CC cross sections at $Q=10\GEV$ and $x=0.01$.
\begin{table}[t] 
  \centering
...
approximate \NNNLO{} splitting functions. It is interesting to note
...
table took a total of 7 minutes to obtain on a laptop equipped with an
Intel i9-10885H CPU.
