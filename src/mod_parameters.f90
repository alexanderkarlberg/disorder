...
contains
  ...
  subroutine set_parameters 
    ...
    call hoppetSetN3LOnfthresholds(int_val_opt('-vfns3-option',1)) 
...
!       call sleep(1)
  ...
  subroutine help_message
    ...
    write(0,'(a)') ' -nlocoef/-nnlocoef/-n3locoef : Run only NLO/NNLO/N3LO coef. '
    ...
    write(0,'(a)') ' -pdf : toyHERALHC (default) | toyNF5                        '
    ...
    write(0,'(a)') ' -toy-alphas-Q0 (dble) [0.35]: value of αS at Q0             '
    write(0,'(a)') ' -mc/-mb/-mt (dble): specify values of heavy quarks          '
    write(0,'(a)') '                                                             '
